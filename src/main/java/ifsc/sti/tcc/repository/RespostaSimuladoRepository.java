...
public interface RespostaSimuladoRepository extends JpaRepository<RespostaSimulado, Long> {
	...
	@Query(value = "SELECT count(*) FROM resposta_simulado as rs inner join simulado s on s.id_simulado = rs.id_simulado where s.id_usuario = ?1", nativeQuery = true)
...
//	Por Area Total, criador do simulado
	...
	@Query(value = "select count(*) from resposta_simulado_respostas as rsp inner join resposta_simulado rs on rs.id_resposta_simulado = rsp.resposta_simulado_id_resposta_simulado inner join resposta_questao as rq on rq.id_resposta_questao = rsp.respostas_id_resposta_questao inner join questao as q on q.id_questao = rq.id_questao inner join simulado s on s.id_simulado = rs.id_simulado where s.id_usuario = ?1 and rq.respondida = false and q.area = ?2", nativeQuery = true)
...
//	Simulado resposta do usuário
	...
	List<Object[]> disciplinaSimuladoPorUsuario(long idUsuario, long idSimulado);
	...
	List<Object[]> resultadoDisciplinaSimuladoErroPorUsuario(long idUsuario, long idSimulado);
	...
	List<Object[]> resultadoDisciplinaSimuladoAcertoPorUsuario(long idUsuario, long idSimulado);
	...
	List<Object[]> resultadoDisciplinaSimuladoNaoRespondidaPorUsuario(long idUsuario, long idSimulado);
