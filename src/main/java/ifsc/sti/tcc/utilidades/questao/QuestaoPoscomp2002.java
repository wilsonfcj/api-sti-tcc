...
public class QuestaoPoscomp2002 {
	...
	public static List<Questao> registerPoscomp2002() {
		...
		questaoAlternativa1.setNumeroQuestao(1);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa2.setNumeroQuestao(2);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa3.setNumeroQuestao(3);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa4.setNumeroQuestao(4);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa5.setNumeroQuestao(5);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa6.setNumeroQuestao(6);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa7.setNumeroQuestao(7);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa8.setNumeroQuestao(8);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa9.setNumeroQuestao(9);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa11.setNumeroQuestao(11);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa14.setNumeroQuestao(14);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa15.setNumeroQuestao(15);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa16.setNumeroQuestao(16);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa17.setNumeroQuestao(17);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa18.setNumeroQuestao(18);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa19.setNumeroQuestao(19);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa20.setNumeroQuestao(20);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa21.setNumeroQuestao(21);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa22.setNumeroQuestao(22);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa24.setDescricao("Considere o projeto de um circuito digital que implementa uma função $f$ com três variáveis de entrada e satisfazendo as seguintes propriedades: \r\n" + 
				"\r\n" + 
		...
		questaoAlternativa25.setDescricao("Assinale quantas sequências de caracteres a seguir são reconhecidas pelo autômato finito abaixo. As quatro sequências de caracteres (separadas por vírgulas) são: 0, +567, -89.5, -3e3.");
...
//		---------------------------------------------------------------
		...
		questaoAlternativa26.setAlternativasA("Uma linguagem que é recusirvamente enumerável não pode ser uma linguagem regular");
		questaoAlternativa26.setAlternativasB("As linguagens livres de contexto e as linguagens sensíveis a contexto se excluem");
		questaoAlternativa26.setAlternativasC("Uma linguagem que não é regular é livre de contexto");
		questaoAlternativa26.setAlternativasD("As linguagens reconhecidas por autômatos a pilha são as linguagens regulares");
		questaoAlternativa26.setAlternativasE("Há linguagens que não são nem livres de contexto nem sensíveis a contexto");
		questaoAlternativa26.setNumeroQuestao(26);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa27.setDescricao("Suponha que T seja uma árvore AVL inicialmente vazia, e considere a inserção dos elementos 10,20,30,5,15,2 em T, nesta ordem. Qual das sequências abaixo corresponde a um percurso de T em pré-ordem:");
		...
		questaoAlternativa27.setNumeroQuestao(27);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa28.setNumeroQuestao(28);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa29.setNumeroQuestao(29);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa30.setNumeroQuestao(30);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa31.setNumeroQuestao(31);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa32.setDescricao("Quais dos algoritmos de ordenação abaixo possuem tempo no pior caso e tempo médio de execução proporcional a $O\\left(n \\log_{}{n}\\right)$");
		...
		questaoAlternativa32.setNumeroQuestao(32);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa33.setAlternativasA("Super Merge não está correto. Não é possível ordenar quebrado o vetor em 4 partes");
		...
		questaoAlternativa33.setNumeroQuestao(33);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa34.setNumeroQuestao(34);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa35.setDescricao("Considere um sistema distribuído onde cada nó precisa obter um bloqueio(lock) antes de acessar qualquer serviço no sistema. Qual das estrtégias a seguir não será eficaz para evitar impasses (deadlocks)?");
		...
		questaoAlternativa35.setAlternativasA("Associar prioridades aos nós e criar filhos de prioridades para cada serviço");
		questaoAlternativa35.setAlternativasB("Numerar os serviços e exigir que cada nó solicite os bloqueios dos serviços em ordem crescente");
		questaoAlternativa35.setAlternativasC("Instalar um serviço de detecção de impasses no sistema distribuído e reiniciar os nós que atinjam um impasse");
		questaoAlternativa35.setAlternativasD("Fazer com que cada nó reinicie sua execução se um pedido de bloqueio não é concedido após um longo tempo de espera. O pedido de bloqueio é reenviado após um tempo aleatório");
		questaoAlternativa35.setAlternativasE("Forçar cada nó a obter todos os bloqueios de que necessita no início de su execução e reiniciar a execução se algum bloqueio não é concedido");
		questaoAlternativa35.setNumeroQuestao(35);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa36.setAlternativasE("t = p->dir;" + 
				"$\\newline$p->dir = p-esq;" + 
				"$\\newline$p->esq = t");
		questaoAlternativa36.setNumeroQuestao(36);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa37.setDescricao("No programa abaixo, escrito em Pascal, os parâmetros do procedimento vr são passados por valor, conforme a imagem abaixo" + 
		...
		questaoAlternativa37.setNumeroQuestao(37);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa38.setNumeroQuestao(38);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa39.setNumeroQuestao(39);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa40.setDescricao("Considere um grafo G satisfazendo as seguintes propriedades:  \r\n" + 
				"$\\newline$• G é conexo\r\n" + 
		...
		questaoAlternativa40.setNumeroQuestao(40);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa41.setDescricao("Supondo a Relação PROJ (PNO, Nome, Orçam), com chave primária PNO e a Relação\r\n" + 
		...
		questaoAlternativa41.setNumeroQuestao(41);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa42.setDescricao("Dentre as definições a seguir, ligadas ao conceito de normalização do modelo relacional, qual delas é INCORRETA?");
		...
		questaoAlternativa42.setAlternativasB("A primeira forma normal estabelece que os atributos da relação contêm apenas valores atômicos. ");
		questaoAlternativa42.setAlternativasC("A normalização é um processo passo a passo reversível de substituição de uma dada coleção de relações por sucessivas coleções de relações as quais possuem uma estrutura progressivamente mais simples e mais regular.");
		questaoAlternativa42.setAlternativasD("As relações que obedecem à primeira forma normal não apresentam anomalias.");
		questaoAlternativa42.setAlternativasE("O objetivo da normalização é eliminar várias anomalias (ou aspectos indesejáveis) de uma relação.");
		questaoAlternativa42.setNumeroQuestao(42);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa43.setDescricao("Dentre as definições a seguir, ligadas ao conceito de visões do modelo relacional, qual delas é INCORRETA?");
		...
		questaoAlternativa43.setNumeroQuestao(43);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa44.setNumeroQuestao(44);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa45.setNumeroQuestao(45);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa46.setNumeroQuestao(46);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa47.setNumeroQuestao(47);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa48.setNumeroQuestao(48);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa50.setNumeroQuestao(50);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa51.setNumeroQuestao(51);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa52.setNumeroQuestao(52);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa53.setNumeroQuestao(53);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa54.setNumeroQuestao(54);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa55.setNumeroQuestao(55);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa56.setNumeroQuestao(56);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa57.setNumeroQuestao(57);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa58.setNumeroQuestao(58);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa60.setNumeroQuestao(60);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa61.setNumeroQuestao(61);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa62.setNumeroQuestao(62);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa65.setNumeroQuestao(65);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa66.setNumeroQuestao(66);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa67.setNumeroQuestao(67);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa68.setNumeroQuestao(68);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa69.setNumeroQuestao(69);
...
//		---------------------------------------------------------------
		...
		questaoAlternativa70.setNumeroQuestao(70);
